...
* Display the image created by `pyxeleditor`
...
```bash
git clone https://github.com/ytyaru/Python.Pyxel.Draw.Image.20200331124713
cd Python.Pyxel.Draw.Image.20200331124713/src
./run.sh
```
